...
path_src_result_raw = Pathlists.RESULT_SAVE_DIR_RAW

path_src_result = path_src_result_raw
...
def test_edxgbs(path_xgb_model, intermediate_test_output, algorithm_name, index, setName,
    ...
    # aucs.append(float(auc_score))
    # mccs.append(float(mcc_score))
    ...
    # dataFrm2 = pd.DataFrame([report_edeepxgb])
            ...
            for Learning_Rate in lrates:
                ...
                for i in range(1, count):
                    ...
                    new_xgbpath = path_src_model + '{}_models_{}/_{}{}_{}_{}.h5'.format(item_key, dataset_name,
                                                                                      algorithm_name[0:10], i,
                                                                                      dataset_name+'_Original_DExfil_ROSampler', new_xgb_name)
...
if __name__ == '__main__':
    ...
    for file_name, model_name_index in data_files.items():
            ...
            print('********************** {}: {} ***************************'.format(file_name, model_name_index))
            for dataset_name in dataname:
                ...
                for sampler in samplers:
                    for test_file in samplers:
                        ...
                        # converting label 8 & 9
                        dataset = ML_model.labelChange(Data=df, dataset_name=dataset_name, file_name=file_name_, model_index=model_name_index)
                        # ========== dnn-based ==============
